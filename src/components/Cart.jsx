          ...
          {cartItems?.length === 0 ? <CartEmpty onCartToggle={onCartToggle} /> : <div>
            ...
            <div className="fixed bottom-0 bg-white w-full px-5 py-2 grid items-center">
              ...
              <div className="grid items-center gap-2">
                <p className="text-sm font-medium text-center">GST (Excluded) will be calculated at checkout</p>
                <button type="button" className="button-theme bg-theme-cart text-white">Proceed to Check Out</button>
              </div>
            </div>
