...
const heroapi = {
  title: "BARTER VAULT",
  subtitle: "Best Value for your Sneakers",
  img: heroimg,
...
const popularsales = {
  title: "Best Re-Selling Sneakers",
  items: [
    {
      id: "0p0x1",
      title: "Yeezy X Adidas Black White",
...
const highlight = {
  ...
  btn: "Explore More",
  url: "https://www.adidas.co.in/dame-extply-2.0-shoes/GY2443.html",
  img: hightlightimg,
};

const sneaker = {
  heading: "FEATURED",
  title: "ADIDAS SNEAKERS AIR SHOES",
  text: "The radiance lives on Adidas Sneakers Air Shoes, the basket ball OG that puts a fresh spin on what you know best: durably stitched overlays, clean finishes and the perfect amount of flash to make you shine.",
  btn: "Explore More",
  url: "https://sneakernews.com/2020/04/01/adidas-yeezy-boost-350-v2-cinder-reflective/",
  img: sneakershoe,
};
...
const toprateslaes = {
  ...
  items: [
    ...
    {
      id: "0M0x7",
      title: "PUMA MOTOSPORT EDITION",
      text: "Porsche Edition",
      rating: "4.6",
      btn: "Buy Now",
      img: product1,
      price: "4399",
...
const footerAPI = {
  titles: [ {title: "About Barter_Vault"},{title: "Get Help"},{title: "Company"} ],
  links: [
    [
      {link: "News"},
      {link: "Careers"},
